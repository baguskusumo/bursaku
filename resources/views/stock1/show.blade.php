...
@section('content')
    <div class="row mt-5 mb-5">
        <div class="col-lg-12 margin-tb">
			...
			<form action="{{ route('stock1.store') }}" method="POST">
			@csrf
			 ...
			 <div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="form-group">
						...
						<input type="text" name="nama" readonly class="form-control" placeholder="Nama Mobil" value="{{ $item->nama_mobil }}">
					</div>
				</div>
				<div class="col-xs-12 col-sm-12 col-md-12">
					<div class="form-group">
